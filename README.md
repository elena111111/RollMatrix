ƒанна€ программа генерирует матрицу нужной размерности, заполн€€ ее натуральными числами, "закручива€" их по часовой стрелке.
Ќиже примеры работы с программой из командной строки:
